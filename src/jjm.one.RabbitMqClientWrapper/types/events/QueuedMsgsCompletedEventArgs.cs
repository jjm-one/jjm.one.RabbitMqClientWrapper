...
public class QueuedMsgsCompletedEventArgs : EventArgs
{
    #region ctor
    ...
    /// <summary>
    ///     The flag indicates whether getting the amount of queued msg's from the RabbitMQ server was successfully completed
    ///     or not.
    /// </summary>
