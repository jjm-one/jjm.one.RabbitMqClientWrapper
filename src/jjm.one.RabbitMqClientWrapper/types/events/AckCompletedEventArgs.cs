...
public class AckCompletedEventArgs
{
    ...
    /// <summary>
    /// The default constructor of the <see cref="AckCompletedEventArgs"/> class.
    /// </summary>
    /// <param name="successful"></param>
    /// <param name="exception"></param>
    /// <param name="completionTime"></param>
    /// <param name="deliveryTag"></param>
    public AckCompletedEventArgs(bool successful = false, Exception? exception = null,
